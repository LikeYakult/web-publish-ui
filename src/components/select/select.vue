    ...
    >
        ...
        <transition name="transition-drop">
            ...
            >
                ...
                <ul :class="[prefixCls + '-dropdown-list', { ['no-padding']: showNotFoundLabel }]">
                    <functional-options
...
const optionRegexp = /^option$|^Option$/i;
    ...
    computed: {
        ...
        dropdownCls () {
            return {
                ...
                ['trade-auto-complete']: this.autoComplete,
