<template>
    ...
    <ul :class="wrapClasses" :style="styles" v-else>
        <span :class="[prefixCls + '-total']" v-if="showTotal">
            <slot>{{ $t('page.total') }} {{ total }} <template v-if="total <= 1">{{ $t('page.item') }}</template><template
                v-else>{{ $t('page.items') }}</template></slot>
        </span>
        <li
            :title="$t('page.prev')"
            :class="prevClasses"
            ...
            <a>
                ...
                <i v-else class="icon iconfont icon-icon_turnl1"></i></a>
        </li>
        <li title="1" :class="firstPageClasses" @click.stop="changePage(1)"><a>1</a></li>
        <li :title="$t('page.prev5')"
            v-if="currentPage > 5"
        ...
        <li :title="currentPage - 3"
            v-if="currentPage === 5"
            :class="[prefixCls + '-item']"
            @click.stop="changePage(currentPage - 3)"
        >
            <a>{{ currentPage - 3 }}</a>
        </li>
        <li :title="currentPage - 2"
            v-if="currentPage - 2 > 1"
            :class="[prefixCls + '-item']"
            @click.stop="changePage(currentPage - 2)"
        >
            <a>{{ currentPage - 2 }}</a>
        </li>
        <li :title="currentPage - 1"
        ...
        <li :title="allPages"
            ...
            @click.stop="changePage(allPages)"
        >
            <a>{{ allPages }}</a>
        </li>
        <li
            ...
            <a>
                ...
                <i v-else class="icon iconfont icon-icon_turnr1"></i>
            </a>
        </li>
        <Options
