            ...
            <div :class="[prefixCls + '-content', prefixCls + '-content-left']" v-show="!isTime">
                <div :class="[datePrefixCls + '-header']" v-show="currentView !== 'time'">
                    <span
                        ...
                        @click="prevYear('left')"
                    >
                      <i class="icon iconfont icon-icon_turnl"></i>
                    </span>
                    <span
                    ...
                    >
                       <i class="icon iconfont icon-icon_turnl1"></i>
                    </span>
                    <date-panel-label
                    ...
                    <span
                        ...
                        @click="nextYear('left')"
                    >
                        <i class="icon iconfont icon-icon_turnr"></i>
                    </span>
                    <span
                        v-if="splitPanels && leftPickerTable === 'date-table'"
            ...
            <div :class="[prefixCls + '-content', prefixCls + '-content-right']" v-show="!isTime">
                <div :class="[datePrefixCls + '-header']" v-show="currentView !== 'time'">
                    ...
                    <span
                        ...
                        v-show="currentView === 'date'">
                       <i class="icon iconfont icon-icon_turnr1"></i>
                    </span>
                    <date-panel-label
...
export default {
    ...
    methods: {
        ...
        panelLabelConfig (direction) {
            const locale = this.globalLang;
            const datePanelLabel = this.$t("app.datePanelLabel");
            const handler = type => {
